...
See [ECS naming convention migration](1.0.0-ecs-naming-convention.md) for the complete field mapping table.
...
See [ECS naming convention migration](1.0.0-ecs-naming-convention.md) for the complete mapping.
