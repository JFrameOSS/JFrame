 ...
 *
 * <p>Usage: Extend this class with {@code @RequestScoped} and specify the entity type and identifier type.
 *
 * <pre>{@code
 * @RequestScoped
...
public abstract class RequestScopedCache<K, V> {
     ...
     *
     * <p>The loading operation is atomic: the loader will only be invoked if the value is not already present in the
     * cache.
     *
     * @param id     the entity identifier
     ...
     *
     * <p>Newly loaded entities are automatically cached.
     *
     * @param ids         collection of entity identifiers
     ...
     */
    public Map<K, V> getAllOrLoad(final Collection<K> ids, final Function<Collection<K>, Collection<V>> batchLoader) {
     ...
     *
     * <p>Normally not required, as request-scoped beans are destroyed automatically.
     */
    public void clear() {
        cache.clear();
    }
