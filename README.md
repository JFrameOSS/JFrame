...
[![Maven Central](https://img.shields.io/badge/maven--central--0.7.0-blue.svg)](https://search.maven.org/search?q=g:io.github.jframeoss)
...
dependencies {
    ...
    implementation("io.github.jframeoss:starter-core:0.7.0")

    // JPA enhancements (optional)
    implementation("io.github.jframeoss:starter-jpa:0.7.0")

    // OpenTelemetry integration (optional)
    implementation("io.github.jframeoss:starter-otlp:0.7.0")
}
```
