...
[![Maven Central](https://img.shields.io/badge/maven--central--0.8.0-SNAPSHOT-blue.svg)](https://search.maven.org/search?q=g:io.github.jframeoss)
...
dependencies {
    ...
    implementation("io.github.jframeoss:starter-core:0.8.0-SNAPSHOT")

    // JPA enhancements (optional)
    implementation("io.github.jframeoss:starter-jpa:0.8.0-SNAPSHOT")

    // OpenTelemetry integration (optional)
    implementation("io.github.jframeoss:starter-otlp:0.8.0-SNAPSHOT")
}
```
