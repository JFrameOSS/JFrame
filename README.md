...
```kotlin
dependencies {
    implementation("io.github.jframeoss:jframe-spring-core:1.6.2")
    implementation("io.github.jframeoss:jframe-spring-jpa:1.6.2")   // optional
    implementation("io.github.jframeoss:jframe-spring-otlp:1.6.2")  // optional
}
```
...
```kotlin
dependencies {
    implementation("io.github.jframeoss:jframe-quarkus-core:1.6.2")
    implementation("io.github.jframeoss:jframe-quarkus-jpa:1.6.2")   // optional
    implementation("io.github.jframeoss:jframe-quarkus-otlp:1.6.2")  // optional
}
```
