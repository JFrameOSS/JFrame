...
/**
 * Tests for {@link Traced} interceptor binding annotation.
 *
 * <p>Verifies that the annotation has the correct retention, targets, and
 * is marked as a CDI interceptor binding.
 */
@DisplayName("Quarkus OTLP - Traced Annotation")
public class TracedAnnotationTest extends UnitTest {

    @Test
    @DisplayName("Should have RUNTIME retention")
    public void shouldHaveRuntimeRetention() {
        // Given: The Traced annotation class

        // When: Inspecting its Retention meta-annotation
        final Retention retention = Traced.class.getAnnotation(Retention.class);
    ...
    public void shouldBeApplicableToTypeAndMethodTargets() {
        ...
        final Target target = Traced.class.getAnnotation(Target.class);
    ...
    public void shouldBeAnnotatedWithInterceptorBinding() {
        ...
        final InterceptorBinding interceptorBinding = Traced.class.getAnnotation(InterceptorBinding.class);
